...
import { LogOut, Menu, X, ChevronRight, AlertTriangle, Pencil, ArrowLeft } from 'lucide-react'
  ...
  return (
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <aside className={cn(
        ...
        {/* Footer Actions: Back to Landing Page & Logout */}
        <div className="px-3 py-4 border-t border-white/10 flex items-center gap-2">
          <button
            onClick={() => navigate('/')}
            title="Return to main landing page without logging out"
            className="flex-1 flex items-center justify-center gap-2 px-3 py-3 rounded-xl text-white/80 hover:bg-white/10 hover:text-white font-poppins font-medium text-sm transition-all duration-150 touch-manipulation border border-white/10 hover:border-white/20"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-3 py-3 rounded-xl text-white/80 hover:bg-red-500/20 hover:text-red-200 font-poppins font-medium text-sm transition-all duration-150 touch-manipulation border border-white/10 hover:border-red-500/30"
          >
