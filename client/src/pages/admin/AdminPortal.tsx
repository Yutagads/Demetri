...
const navItems = [
  ...
  { label: 'Account Status', path: '/admin/student-account-status', icon: <ShieldCheck className="w-5 h-5" /> },
  ...
  return (
    <PortalLayout navItems={navItems}>
      <Routes>
        ...
        <Route path="student-account-status" element={<AdminStudentAccountStatus />} />
