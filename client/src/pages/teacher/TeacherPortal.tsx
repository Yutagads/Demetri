...
import { LayoutDashboard, ClipboardList, Monitor, BarChart2, Calendar, BookOpen, FolderOpen, User } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'My Profile', path: '/teacher/profile', icon: <User className="w-5 h-5" /> },
...
export default function TeacherPortal() {
  ...
  return (
    <PortalLayout
      navItems={navItems}
      inactivityMinutes={Number(settings.kioskIdleTimeout) || 15}
      onProfileEdit={() => navigate('/teacher/profile')}
    >
      <Routes>
